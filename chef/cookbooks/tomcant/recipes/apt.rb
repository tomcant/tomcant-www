# Add dotdeb apt repos and key.
node.default['fb_apt']['repos'] << "deb http://packages.dotdeb.org jessie all"
node.default['fb_apt']['repos'] << "deb-src http://packages.dotdeb.org jessie all"
node.default['fb_apt']['keys']['89DF5277'] = <<-eos
...
# Add nginx apt repos and key.
node.default['fb_apt']['repos'] << 'deb http://nginx.org/packages/debian/ jessie nginx'
node.default['fb_apt']['repos'] << 'deb-src http://nginx.org/packages/debian/ jessie nginx'
node.default['fb_apt']['keys']['7BD9BF62'] = <<-eos
-----BEGIN PGP PUBLIC KEY BLOCK-----
